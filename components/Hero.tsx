  ...
  return (
    <section id="home" className="min-h-[85vh] flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="mt-16 flex items-center gap-6">
        ...
        <a href="https://www.linkedin.com/in/zaher-mardini-7464ab39a" target="_blank" className="text-slate-400 hover:text-blue-500 transition-colors">
