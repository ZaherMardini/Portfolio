  ...
  return (
    <section id="home" className="min-h-[85vh] flex flex-col items-center justify-center px-6 text-center">
      ...
      <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-white mb-6">
        I build robust <span className="bg-gradient-to-r from-blue-500 to-indigo-400 bg-clip-text text-transparent">Backend Systems</span>
      </h1>
      ...
      <div className="mt-16 flex items-center gap-6">
        ...
        <a href="https://linkedin.com" target="_blank" className="text-slate-400 hover:text-blue-500 transition-colors">
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
        </a>
        <a href="mailto:hello@example.com" className="text-slate-400 hover:text-red-400 transition-colors">
